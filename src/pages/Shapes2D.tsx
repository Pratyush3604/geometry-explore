...
const shapes2D: Shape2DData[] = [
  ...
  {
    id: "lens",
    name: "Lens (Vesica Piscis)",
    description: "The intersection of two circles of equal radius. Used in Christian iconography and sacred geometry.",
    area: "A = 2r²(π/3 - √3/4)",
    perimeter: "P = 4πr/3",
    symmetryLines: "2",
    properties: ["Two circular arcs", "Pointed ends", "Sacred geometry", "Fish bladder shape"],
    color: "hsl(195 90% 55%)",
    category: "curves",
  },
  {
    ...
    description: "A pie-slice portion of a circle bounded by two radii and an arc. Common in pie charts.",
    area: "A = (θ/360°)πr²",
    perimeter: "P = 2r + (θ/360°)2πr",
    symmetryLines: "1 (if θ symmetric)",
    properties: ["Two straight edges", "One curved edge", "Pie slice shape", "Central angle θ"],
    color: "hsl(330 85% 65%)",
    category: "curves",
  },
  {
    ...
    description: "The region between a chord and its arc. Used in architecture and engineering for arched structures.",
    area: "A = r²(θ - sin θ)/2",
    perimeter: "P = rθ + 2r sin(θ/2)",
    symmetryLines: "1",
    properties: ["One chord", "One arc", "No vertices", "Part of circle"],
    color: "hsl(160 70% 45%)",
    category: "curves",
  },
  {
    id: "arbelos",
    name: "Arbelos",
    description: "A region bounded by three semicircles. Named 'shoemaker's knife' in Greek. Has interesting geometric properties.",
    area: "A = (π/4)(ab)",
    perimeter: "Sum of three semicircles",
    symmetryLines: "0",
    properties: ["Three semicircles", "Shoemaker's knife", "Archimedes studied it", "Twin circles inside"],
    color: "hsl(35 90% 55%)",
    category: "curves",
  },
  ...
  },
  {
    ...
    description: "A right triangle with two equal legs and a 90° angle. The 45-45-90 triangle used in geometry.",
    area: "A = ½ × a²",
    perimeter: "P = 2a + a√2",
    interiorAngleSum: "180°",
    exteriorAngleSum: "360°",
    symmetryLines: "1",
    properties: ["45-45-90 angles", "Two equal legs", "Hypotenuse = a√2", "Half of a square"],
    color: "hsl(259 85% 65%)",
    category: "triangles",
  },
  {
    ...
    description: "A special right triangle with angles 30°, 60°, and 90°. Has sides in ratio 1:√3:2.",
    area: "A = (√3/4) × (hypotenuse)²",
    perimeter: "P = a(3 + √3)",
    interiorAngleSum: "180°",
    exteriorAngleSum: "360°",
    properties: ["30-60-90 angles", "Side ratio 1:√3:2", "Half of equilateral", "Common in geometry"],
    color: "hsl(195 90% 55%)",
    category: "triangles",
  },
  ...
  {
    id: "isosceles-trapezoid",
    name: "Isosceles Trapezoid",
    description: "A trapezoid with equal non-parallel sides (legs). Has reflective symmetry and equal base angles.",
    area: "A = ½(a + b) × h",
    perimeter: "P = a + b + 2c",
    interiorAngleSum: "360°",
    exteriorAngleSum: "360°",
    symmetryLines: "1",
    properties: ["Equal legs", "Equal base angles", "Diagonals equal", "1 line of symmetry"],
    color: "hsl(330 85% 65%)",
    category: "quadrilaterals",
  },
  {
    ...
    description: "A trapezoid with two adjacent right angles. One leg is perpendicular to both bases.",
    area: "A = ½(a + b) × h",
    perimeter: "P = a + b + c + h",
    interiorAngleSum: "360°",
    exteriorAngleSum: "360°",
    properties: ["Two 90° angles", "One perpendicular leg", "Adjacent right angles", "Used in calculus"],
    color: "hsl(160 70% 45%)",
    category: "quadrilaterals",
  },
  {
  ...
  },
  {
    id: "dart",
    name: "Dart (Arrowhead)",
    description: "A concave quadrilateral, like a kite but with one reflex angle. Used in Penrose tilings.",
    area: "A = ½ × d₁ × d₂",
    perimeter: "P = 2(a + b)",
    interiorAngleSum: "360°",
    exteriorAngleSum: "360°",
    symmetryLines: "1",
    properties: ["Concave kite", "One reflex angle", "Penrose tiling", "Arrow shape"],
    color: "hsl(259 85% 65%)",
    category: "quadrilaterals",
  },
  ...
  },
  {
    ...
    description: "A thirteen-sided polygon. Also called triskaidecagon. Cannot be constructed with compass and straightedge.",
    area: "A ≈ 13.186 × s²",
    perimeter: "P = 13s",
    interiorAngleSum: "1980°",
    exteriorAngleSum: "360°",
    eachInteriorAngle: "152.31°",
    eachExteriorAngle: "27.69°",
    diagonals: "65 diagonals",
    symmetryLines: "13",
    properties: ["13 equal sides", "13-fold symmetry", "Not constructible", "Prime number sides"],
    color: "hsl(195 90% 55%)",
    category: "polygons",
  },
  {
    ...
    description: "A fourteen-sided polygon. Very close to circular. Related to the heptagon.",
    area: "A ≈ 15.33 × s²",
    perimeter: "P = 14s",
    interiorAngleSum: "2160°",
    exteriorAngleSum: "360°",
    eachInteriorAngle: "154.29°",
    eachExteriorAngle: "25.71°",
    diagonals: "77 diagonals",
    symmetryLines: "14",
    properties: ["14 equal sides", "14-fold symmetry", "77 diagonals", "Double heptagon"],
    color: "hsl(330 85% 65%)",
    category: "polygons",
  },
  {
    ...
    description: "A fifteen-sided polygon. Constructible with compass and straightedge. Used in some coin designs.",
    area: "A ≈ 17.64 × s²",
    perimeter: "P = 15s",
    interiorAngleSum: "2340°",
    exteriorAngleSum: "360°",
    eachInteriorAngle: "156°",
    eachExteriorAngle: "24°",
    diagonals: "90 diagonals",
    symmetryLines: "15",
    properties: ["15 equal sides", "15-fold symmetry", "Constructible", "90 diagonals"],
    color: "hsl(160 70% 45%)",
    category: "polygons",
  },
  {
    ...
    description: "A sixteen-sided polygon. Very close to a circle. Constructible with compass and straightedge.",
    area: "A ≈ 20.11 × s²",
    perimeter: "P = 16s",
    interiorAngleSum: "2520°",
    exteriorAngleSum: "360°",
    eachInteriorAngle: "157.5°",
    eachExteriorAngle: "22.5°",
    diagonals: "104 diagonals",
    symmetryLines: "16",
    properties: ["16 equal sides", "16-fold symmetry", "Constructible", "104 diagonals"],
    color: "hsl(35 90% 55%)",
    category: "polygons",
  },
  ...
  {
    id: "star10",
    name: "10-Point Star (Decagram)",
    description: "A ten-pointed star created from a decagon. Contains golden ratio in its proportions.",
    area: "Complex calculation",
    perimeter: "20 × side length",
    symmetryLines: "10",
    properties: ["10 points", "20 edges", "Golden ratio", "10-fold symmetry"],
    color: "hsl(160 70% 45%)",
    category: "special",
  },
  {
    id: "star12",
    name: "12-Point Star (Dodecagram)",
    description: "A twelve-pointed star created from overlapping shapes. Common in clocks and decorative patterns.",
    area: "Complex calculation",
    perimeter: "24 × side length",
    symmetryLines: "12",
    properties: ["12 points", "24 edges", "Clock-like", "12-fold symmetry"],
    color: "hsl(259 85% 65%)",
    category: "special",
  },
  {
  ...
  },
  {
    id: "trefoil",
    name: "Trefoil",
    description: "A three-lobed shape made of three overlapping circles. Common in Gothic architecture and Irish symbols.",
    area: "Sum of three sectors",
    perimeter: "Sum of three arcs",
    symmetryLines: "3",
    properties: ["Three lobes", "3-fold symmetry", "Celtic knot base", "Gothic windows"],
    color: "hsl(195 90% 55%)",
    category: "special",
  },
  {
    id: "quatrefoil",
    name: "Quatrefoil",
    description: "A four-lobed shape made of four overlapping circles. Common in architecture and decorative arts.",
    area: "Sum of four sectors",
    perimeter: "Sum of four arcs",
    symmetryLines: "4",
    properties: ["Four lobes", "4-fold symmetry", "Gothic design", "Cross alternative"],
    color: "hsl(160 70% 45%)",
    category: "special",
  },
  {
    ...
    description: "A spiral with constant distance between turns. Used in watch springs and scroll patterns.",
    area: "A = πr²/2 (after one turn)",
    perimeter: "Length = r × θ",
    symmetryLines: "0",
    properties: ["Constant spacing", "Infinite length", "Self-similar", "Watch spring shape"],
    color: "hsl(35 90% 55%)",
    category: "special",
  },
  {
    id: "golden-spiral",
    name: "Golden Spiral",
    description: "A logarithmic spiral based on the golden ratio. Found in nautilus shells and galaxies.",
    area: "Approximated by rectangles",
    perimeter: "Infinite",
    symmetryLines: "0",
    properties: ["Golden ratio based", "Self-similar", "Nature's spiral", "Fibonacci related"],
    color: "hsl(259 85% 65%)",
    category: "special",
  },
];
